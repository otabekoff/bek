...
<doc>
@slot header @description Header section. By default you need to set this slot on your bekHeader component.
@slot content @description Content section. By default you need to set this slot on your bekContent component.
@slot footer @description Footer section. By default you need to set this slot on your bekFooter component.
@slot start-sidebar @description Sidebar section. In ltr mode this is renders on left. Behavior is based on main direction. By default you need to set this slot on your bekSidebar component.
@slot end-sidebar @description Sidebar section. In ltr mode this is renders on right. Behavior is based on main direction. By default you need to set this slot on your bekSidebar component.
