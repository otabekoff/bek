...
@data val = 'Normal'
<bekInput placeholder="Type something" v-model="val" type="password"/> {{val}}
...
@data val = 'Multi\nLine'
<bekInput placeholder="Type something" multiLine v-model="val" />
...
@data val = 'Sizes'
<bekInput placeholder="Type something" css-size="sm" v-model="val" />
<bekInput placeholder="Type something" css-size="md" v-model="val" />
<bekInput placeholder="Type something" css-size="lg" v-model="val" />
<bekInput placeholder="Type something" css-size="xl" v-model="val" />
...
@data val = 'Colors'
<bekInput css-color="background" v-model="val" />
<bekInput css-color="header" v-model="val" />
<bekInput css-color="sidebar" v-model="val" />
</example>
