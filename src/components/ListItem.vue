...
@slot sub-list @description If the list-item has a sub list, put new bekList component inside with this slot name.
</doc>
...
<bekList>
  <bekListItem> Item #1 </bekListItem>
  <bekListItem> Item #2 </bekListItem>
  <bekListItem> Item #3 </bekListItem>
</bekList>
</example>
...
<bekList>
  <bekListItem> Item #1 </bekListItem>
  <bekListItem> Item #2 </bekListItem>
  <bekListItem expanded>
    Item #3
    <bekList slot="sub-list">
      <bekListItem> Item #3-1 </bekListItem>
      <bekListItem> Item #3-2 </bekListItem>
      <bekListItem> Item #3-3 </bekListItem>
    </bekList>
  </bekListItem>
</bekList>
</example>
