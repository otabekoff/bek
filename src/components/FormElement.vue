...
@prop inline @type Boolean @default false @description Only set this true for inline form elements including bekCheck, bekSwitch, etc.
...
<bekForm css-row="bek-row" @submit="alert('submit')" @reject="alert('reject')">
  <bekFormElement css-col-lg="4" css-col-md="6" css-margin="sm">
    <label slot="label"> Name </label>
    <bekInput v-model="val1" placeholder="Enter your name" required/>
  </bekFormElement>
  <bekFormElement css-col-lg="4" css-col-md="6" css-margin="sm">
    <label slot="label"> Family </label>
    <bekInput v-model="val2" placeholder="Enter your family" required/>
  </bekFormElement>
  <bekFormElement css-col-lg="4" css-col-md="6" css-margin="sm">
    <label slot="label"> Age </label>
    <bekSelect v-model="val3" placeholder="Enter your age" required>
      <bekSelectOption value="-7"> Under 7 </bekSelectOption>
      <bekSelectOption value="7-13"> 7 to 13 </bekSelectOption>
      <bekSelectOption value="13-25"> 13 to 25 </bekSelectOption>
      <bekSelectOption value="+26"> More than 26 </bekSelectOption>
    </bekSelect>
  </bekFormElement>
  <div css-col="12" css-margin="sm">
    <bekButton type="submit"> Done </bekButton>
  </div>
