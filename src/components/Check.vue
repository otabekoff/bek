...
@data val = 'md'
<bekCheck content="ss" v-model="val"> Super-Small </bekCheck>
<bekCheck content="xs" v-model="val"> X-Small </bekCheck>
<bekCheck content="sm" v-model="val"> Small </bekCheck>
<bekCheck content="md" v-model="val"> Medium </bekCheck>
<bekCheck content="lg" v-model="val"> Large </bekCheck>
<bekCheck content="xl" v-model="val"> X-Large </bekCheck>
<bekCheck content="sl" v-model="val"> Super-Large </bekCheck>
</example>
...
@data val = ['md']
<bekCheck content="ss" v-model="val" multiple> Super-Small </bekCheck>
<bekCheck content="xs" v-model="val" multiple> X-Small </bekCheck>
<bekCheck content="sm" v-model="val" multiple> Small </bekCheck>
<bekCheck content="md" v-model="val" multiple> Medium </bekCheck>
<bekCheck content="lg" v-model="val" multiple> Large </bekCheck>
<bekCheck content="xl" v-model="val" multiple> X-Large </bekCheck>
<bekCheck content="sl" v-model="val" multiple> Super-Large </bekCheck>
</example>
