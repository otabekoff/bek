...
@data val = undefined
<bekDatepicker v-model="val" placeholder="Choose Date" />
</example>
...
@data val = undefined
<bekDatepicker v-model="val" :pick="['date', 'time']" placeholder="Select Date and Time" />
</example>
...
@data val = undefined
<bekDatepicker v-model="val" :pick="['time']" placeholder="Select Time" />
</example>
...
<bekDatepicker v-model="val" placeholder="Select Date and Time" :validation="validation" />
</example>
...
<bekDatepicker v-model="val" :pick="['date', 'time']" placeholder="Choose Jalaali Date" :date-constructor="IDate" />
</example>
