...
<doc>
@doc @description Bek version 3 has new component named bekThemeProviver for theming and styling. Using this component is mandatory and should be used at root level of your app.

@prop direction @type oneOf('ltr', 'rtl') @default 'ltr' @description App direction.
@prop sizes @type Object { sizeName: Number /* px value */ } @default { base: 8, font: 14, radius: 6, shadow: 2 } @description Application sizes. Keys described in default value will use in bek styling system, others will accessable with `$theme.sizes` object provided by this component.
@prop colors @type Object { colorName: String /* hex color */ } @default { background: '#FFF', gray: '#AAA', primary: '#0B62EA', danger: '#EF2424', header: '#0B62EA', sidebar: '#2B2B2B', footer: '#152235' } @description Application colors. Keys described in default value will use in bek styling system, others will accessable with `$theme.colors` object provided by this component.
