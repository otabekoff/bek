<template>
  <div class="bek-margin-top bek-margin-bottom">
    <bekSlider v-model="slider">
      <template
        slot="tab"
        slot-scope="scope"
      >
      ...
      <bekSlide
        v-for="tab in tabs"
        :key="tab.slot"
        class="bek-padding-top bek-padding-bottom"
      >
        <bekTable
          class="bek-border bek-shadow bek-radius"
        ...
        >
          <template
            ...
            slot-scope="scope"
          >
            <b class="bek-text-secondary">{{ nameFormatter(scope.row.name).title }}</b> <b
              v-if="nameFormatter(scope.row.name).required"
              class="bek-text-danger bek-margin"
            >*</b>
          </template>
          <template
            slot="field-Type"
          ...
          <template
            ...
            slot-scope="scope"
          >
            <span class="bek-text-gray">{{ scope.row.default || '---' }}</span>
          </template>
          <template
            slot="field-Params"
            slot-scope="scope"
